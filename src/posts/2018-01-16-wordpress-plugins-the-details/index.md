...
<div class="youtube-videos video-responsive">
  <div id="tSblOUw97Mc" class="youtube-video">
    <h2 class="youtube-title">How to Build a Basic WordPress Plugin Part 2</h2>
  ...
  <div id="B-tvZAC-eik" class="youtube-video">
    <h2 class="youtube-title">How to Create a Settings Page in WordPress. Part 15</h2>
  ...
  <div id="Zq4eKQD-xgo" class="youtube-video">
    <h2 class="youtube-title">How to Create a Datepicker Field in WordPress Part 14</h2>
  ...
  <div id="yMuUfx-PnTc" class="youtube-video">
    <h2 class="youtube-title">Adding Quicktags to Custom Fields in WordPress Part 13</h2>
  ...
  <div id="yo7FOyBFZIU" class="youtube-video">
    <h2 class="youtube-title">How to Properly Enqueue Styles in WordPress Part 12</h2>
  ...
  <div id="CXkl1FgeM7M" class="youtube-video">
    <h2 class="youtube-title">Understanding and using WordPress Custom Post Types Part 5</h2>
  ...
  <div id="SmaMFF57ixY" class="youtube-video">
    <h2 class="youtube-title">An Introduction into WordPress Filter Hooks Part 4</h2>
  ...
  <div id="S_r0KR0D2PY" class="youtube-video">
    <h2 class="youtube-title">An Introduction into WordPress Action Hooks Part 3</h2>
  ...
  <div id="WnJ0cSNJzAg" class="youtube-video">
    <h2 class="youtube-title">3 - WordPress Plugin Development - Intro to Shortcodes</h2>
  ...
  <div id="MHJFss7gJ7k" class="youtube-video">
    <h2 class="youtube-title">1 - WordPress Plugin Development - Getting Started</h2>
  ...
  <div id="_nW-h52I7Tg" class="youtube-video">
    <h2 class="youtube-title">Wordpress Plugin development - Creating a WP plugin from scratch.</h2>
  ...
  <div id="n9d_fZi_2y8" class="youtube-video">
    <h2 class="youtube-title">WYSIWYG Widgets WordPress Plugin Tutorial - HTML Free Text Editing in a Text Widget</h2>
  ...
  <div id="-mnRzru8rJo" class="youtube-video">
    <h2 class="youtube-title">Building Plugins – WordPress Development for Beginners</h2>
