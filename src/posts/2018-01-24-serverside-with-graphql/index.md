...
<div id="uVksXTuNHaw" class="youtube-video">
  <h2 class="youtube-title">LiveStreaming, building my new tutorial with Phoenix-Elixir, Graphql & React-Native - YouTube</h2>
...
<div id="DNPVqK_woRQ" class="youtube-video">
  <h2 class="youtube-title">Build a GraphQL server for Node.js, using PostgreSQL/MySQL - YouTube</h2>
...
<div id="tlxjhTc_u4o" class="youtube-video">
  <h2 class="youtube-title">ElixirConf 2016 - No REST for the Wicked. Building a GraphQL by  Ben Wilson - YouTube</h2>
...
<div id="tJJMrtJEK1A" class="youtube-video">
  <h2 class="youtube-title">Devon Estes | Refactoring Elixir - Lessons Learned from a Year on Exercism.Io - YouTube</h2>
...
<div id="bd_EIWU9GzQ" class="youtube-video">
  <h2 class="youtube-title">ElixirConf 2017 - Day 1 Keynote - Justin Schneck - YouTube</h2>
...
<div id="gom6nEvtl3U" class="youtube-video">
  <h2 class="youtube-title">GOTO 2017 • Elixir: The only Sane Choice in an Insane World • Brian Cardarella - YouTube</h2>
...
<div id="wVrnoxNbOts" class="youtube-video">
  <h2 class="youtube-title">Let's Get Functional With Elixir! - YouTube</h2>
