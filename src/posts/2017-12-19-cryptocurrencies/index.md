...
<div id="DGH76Nln9NI" class="youtube-video">
  <h2 class="youtube-title">How To Build A Crypto Portfolio With Only $500! - YouTube</h2>
...
<div id="YRba9WUWDl8" class="youtube-video">
  <h2 class="youtube-title">Why Ethereum price will be huge long-term - YouTube</h2>
...
<div id="9zSPKYvZth4" class="youtube-video">
  <h2 class="youtube-title">The Herd Is Coming - Billionaire Mike Novogratz (Ethereal Summit San Francisco 2017) - YouTube</h2>
...
<div id="WSN5BaCzsbo" class="youtube-video">
  <h2 class="youtube-title">Decentralizing Everything with Ethereum's Vitalik Buterin | Disrupt SF 2017 - YouTube</h2>
  <iframe src="https://www.youtube.com/embed/WSN5BaCzsbo" frameborder="0" width="640" height="385" allowfullscreen>
    <p>Your browser does not support iframes.</p>
  </iframe>
...
<div id="RplnSVTzvnU" class="youtube-video">
  <h2 class="youtube-title">How the blockchain will radically transform the economy | Bettina Warburg - YouTube</h2>
...
<div id="zaWQTVGrdps" class="youtube-video">
  <h2 class="youtube-title">Meet CryptoKitties, Digital Kittens on the Blockchain - YouTube</h2>
